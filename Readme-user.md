...
Включаем сюда, по-прежнему, только те суммы, которые можно потом агрегировать за период. 
	...
	OUT: 
	 ...
	 | dom_views    | посещений страниц на домене (равно сумме длин сессий, где длина - количество просмотров неуникальных страниц) | 
